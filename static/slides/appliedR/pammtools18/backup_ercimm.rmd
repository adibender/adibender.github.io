...
- Talk is based on two publications
  - Bender A., A. Groll and F. Scheipl. A generalized additive model approach to
  time-to-event analysis. Statistical Modelling, 2017 (to appear).
  - Bender A., F. Scheipl, W. H. Hartl, A. Day and H. Küchenhoff. Penalized Estimation of complex, non-linear Exposure-Lag-Response Associations. Biostatistics, 2017 (in review)
...
<a itemprop="sameAs" href="https://stackoverflow.com/users/1895521/adibender" target="_blank"><i class="fa fa-stack-overflow big-icon"></i> </a>
